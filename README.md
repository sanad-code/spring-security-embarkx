...
#### To access DB from docker container
- Check compose.yml file for the port mapping.

- JdbcDaoImpl has property DEFAULT_USER_SCHEMA_SQL that is used to create the schema.
- double shift and search for users.ddl to see the schema.
- ```
  CREATE TABLE users (
